...
# Class: ProcessDocSummary
# Description: Doc Summary processing functions
class ProcessDocSummary(ProcessBase):
    def __init__(self, context):
        ProcessBase.__init__(self,context)

    def doc_summary_op(self,task_name,dyn_params={}, **kwargs):
    ...
    def build_doc_summary_task(self, task_name, dyn_params={}):
         ...
         op = PythonOperator(
            ...
            python_callable=self.doc_summary_op,
            op_kwargs=args
         )
         return op
